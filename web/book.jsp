...
<!--[if gt IE 8]><!--> <html class="no-js" id="index" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="book">
            <div class="container">
                <div class="col-lg-4">
                    <img id="bookpageimg" src="images/bookimg/KillerInteractiveSites.gif" alt="Killer Interactive"/>
                </div>
                <div class="col-lg-8">
                    <h1 class="col-lg-12" id="bookpagetitle">Creating Killer Interactive Sites</h1>
                    <h2 class="col-1g-12" id="author">Author: ________</h2>
                    ...
                    <div class="col-lg-12 btns">
                        <div class="col-md-12">
                            <p><a class="btn btn-primary col-md-6" href="checkout.html" role="button"><i class="material-icons">payment</i></a>
